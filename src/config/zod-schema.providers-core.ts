...
export const DiscordGuildChannelSchema = z
  .object({
    ...
    /** Routing strategy for auto-created threads. "classifier" asks the configured LLM whether the main-channel message should become a new thread. */
    autoThreadMode: z.enum(["always", "classifier"]).optional(),
